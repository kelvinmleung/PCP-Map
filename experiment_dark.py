...
loss = pd.read_csv('~/code/PCP-Map/experiments/tabcond/dark_valid_hist.csv').to_numpy()
param = pd.read_csv('~/code/PCP-Map/experiments/tabcond/dark_params_hist.csv').to_numpy()
